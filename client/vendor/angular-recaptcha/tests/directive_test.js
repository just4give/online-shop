describe('directive: vcRecaptcha', function () {
    ...
    describe('invalid key', function () {
        ...
        it('should throw an error - no key', function () {
            ...
            expectedMessage = 'You need to set the "key" attribute to your public reCaptcha key. If you don\'t have a key, please get one from https://profile.google.com/recaptcha/admin/create';
        });
